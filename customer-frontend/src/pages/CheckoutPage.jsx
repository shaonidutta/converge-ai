      ...
      <main className="flex-1 pt-20 pb-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-slate-600 mt-2">Complete your booking in {steps.length} easy steps</p>
          </div>
            ...
            <AnimatePresence mode="wait">
              {currentStep === 1 && (
                <motion.div
                  ...
                  exit={{ opacity: 0, x: -20 }}
                >
                  <h2 className="text-xl font-bold text-slate-900 mb-6">Schedule Your Service</h2>
                  <ServiceScheduler
              ...
              {currentStep === 2 && (
                <motion.div
                  ...
                  exit={{ opacity: 0, x: -20 }}
                >
                  <h2 className="text-xl font-bold text-slate-900 mb-6">Select Service Address</h2>
                  <AddressSelector
